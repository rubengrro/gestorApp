...
const DataTablePapelera = () => {
  const { data: session } = useSession();  // Obtiene la sesión del usuario actual
  ...
  const fetchIncidencias = async () => {
    try {
      ...
      // Filtramos solo las incidencias que tienen una fecha en deletedAt
...
export default DataTablePapelera;
