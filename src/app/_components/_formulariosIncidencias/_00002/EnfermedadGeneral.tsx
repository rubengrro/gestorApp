...
interface EnfermedadGeneralFormProps {
  onClose: () => void;
  selectedIncidencia: {
    concepto: string;
...
const EnfermedadGeneralForm: React.FC<EnfermedadGeneralFormProps> = ({ onClose, selectedIncidencia }) => {
...
export default EnfermedadGeneralForm;
