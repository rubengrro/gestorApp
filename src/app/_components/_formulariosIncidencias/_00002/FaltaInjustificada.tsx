...
interface FaltaInjustificadaFormProps {
  onClose: () => void;
  selectedIncidencia: {
    concepto: string;
...
const FaltaInjustificadaForm: React.FC<FaltaInjustificadaFormProps> = ({ onClose, selectedIncidencia }) => {
...
export default FaltaInjustificadaForm;
